        ...
        <div className="h-screen w-screen flex flex-col justify-center items-center bg-center bg-cover"
            ...
            <div className='h-5/6 w-1/3 bg-white p-1 rounded-2xl shadow-2xl shadow-sky-300'>
                <form className='h-full w-full overflow-y-auto px-7' onSubmit={onSubmit}> 
                    <h1 className='text-3xl text-center p-5 font-semibold text-sky-500'>Recruiter Registration</h1>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <label 
                            ...
                            className="flex items-center justify-center w-40 h-40 border-2 border-sky-500 rounded-full mb-4 cursor-pointer hover:bg-sky-100 transition duration-200"
                        >
                            {profileImage ? (
                                <img
                                    src={profileImage}
                    ...
                    <button type="submit" className='bg-sky-500 p-2 rounded-md w-40 m-3 mb-6'>Submit</button>
                </form>
                <div>
