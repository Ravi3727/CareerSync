...
const Navbar = () => {
  return (
    <header className="text-gray-200 body-font bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700">
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
        <a className="mr-5  hover:text-gray-100 cursor-pointer">First Link</a>
        <a className="mr-5 hover:text-gray-100 cursor-pointer">Second Link</a>
        <a className="mr-5 hover:text-gray-100 cursor-pointer">Third Link</a>
        <a className="mr-5 hover:text-gray-100 cursor-pointer">Fourth Link</a>
      </nav>
